...
*Last close-out: **M1.10 Wave 3** (2026-07-05) — **T3: 0 deviations** — clean wave; headline = band 3 for 0 production-code lines.*
*Prior: **M1.10 Wave 2** (2026-07-05) — T1: 0 deviations. **Wave 1** — 3 entries (T0): 3 Reviewed (archived). T2a/T2b: none.*
