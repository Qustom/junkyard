...
*Empty between waves. Last close-out: **M1.2 Wave 1** (2026-06-19) — 4 deviations, all Reviewed, archived to
`DESIGN_DEVIATIONS_HISTORY.md`. Next entries land here from **M1.2 Wave 2** (I2 / I4 / I3).*
