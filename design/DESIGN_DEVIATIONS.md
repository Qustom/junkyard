...
*None. M1 waves 1 & 2 (archived 2026-06-17) and wave 3 (C1b, E1, D2, B3, C2 — archived 2026-06-17, 21 Reviewed / 3 Addressed) have all been Director-evaluated and moved to `DESIGN_DEVIATIONS_HISTORY.md`.*

*Wave-4 (E2, E3, F1, F2, …) deviations land here as those tasks integrate, then get evaluated at the wave-4 close-out.*
