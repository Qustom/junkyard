...
> ✅ **Status: canonical** (Director-ratified 2026-06-17). When a task spec's code sketch and this
> doc disagree, **this doc wins**. Provenance for each item: `DESIGN_DEVIATIONS_HISTORY.md` (M1 waves 1 & 2).
